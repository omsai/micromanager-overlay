...
SRC_URI="https://www.andor.com/my/ -> ${TARBALL}"

LICENSE="Andor-EULA"
SLOT="2"
KEYWORDS="~amd64"
IUSE="+modules +usb"
REQUIRED_USE="|| ( modules usb )"

RESTRICT="fetch"

DEPEND=""
RDEPEND="usb? ( virtual/libusb:0 dev-libs/libusb-compat )"
...
src_prepare() {
	if use modules; then
		local dir=src/driver
		if kernel_is le 2 4; then
			mv ${dir}/Makefile2.4 ${dir}/Makefile
		else
			mv ${dir}/Makefile2.6 ${dir}/Makefile
		fi
	fi
